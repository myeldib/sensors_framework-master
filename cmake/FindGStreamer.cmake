...
else(GSTREAMER_INCLUDE_DIR AND
      GSTREAMER_LIBRARIES AND
      GSTREAMER_BASE_LIBRARY AND
    (GSTREAMER_INTERFACE_LIBRARY AND GSTREAMER_APP_LIBRARY) OR (GSTREAMER_VERSION_MAJOR GREATER 0) AND
      GSTREAMER_VERSION_MAJOR EQUAL GStreamer_FIND_VERSION_MAJOR AND
...
endif(GSTREAMER_INCLUDE_DIR AND
       GSTREAMER_LIBRARIES AND
       GSTREAMER_BASE_LIBRARY AND
      (GSTREAMER_INTERFACE_LIBRARY AND GSTREAMER_APP_LIBRARY) OR (GSTREAMER_VERSION_MAJOR GREATER 0) AND
       GSTREAMER_VERSION_MAJOR EQUAL GStreamer_FIND_VERSION_MAJOR AND
...
if(NOT WIN32)
    ...
    if(NOT "${GSTREAMER_ROOT}" STREQUAL "")
	    set(ENV{PKG_CONFIG_PATH} "${GSTREAMER_ROOT}/lib/pkgconfig:${GSTREAMER_ROOT}/lib64/pkgconfig:$ENV{PKG_CONFIG_PATH}")
    endif(NOT "${GSTREAMER_ROOT}" STREQUAL "")
...
if(GSTREAMER_INCLUDE_DIR AND GSTREAMER_LIBRARY AND GSTREAMER_BASE_LIBRARY AND
    (GSTREAMER_INTERFACE_LIBRARY AND GSTREAMER_APP_LIBRARY) OR (GSTREAMER_VERSION_MAJOR GREATER 0) )
   set(GSTREAMER_FOUND TRUE)
else(GSTREAMER_INCLUDE_DIR AND GSTREAMER_LIBRARY AND GSTREAMER_BASE_LIBRARY AND
    (GSTREAMER_INTERFACE_LIBRARY AND GSTREAMER_APP_LIBRARY) OR (GSTREAMER_VERSION_MAJOR GREATER 0) )
   set(GSTREAMER_FOUND FALSE)
endif(GSTREAMER_INCLUDE_DIR AND GSTREAMER_LIBRARY AND GSTREAMER_BASE_LIBRARY AND
    (GSTREAMER_INTERFACE_LIBRARY AND GSTREAMER_APP_LIBRARY) OR (GSTREAMER_VERSION_MAJOR GREATER 0) )
...
mark_as_advanced(GSTREAMER_INCLUDE_DIR GSTREAMER_LIBRARY GSTREAMER_LIBRARIES GSTREAMER_BASE_LIBRARY GSTREAMER_INTERFACE_LIBRARY GSTREAMER_APP_LIBRARY GSTREAMER_VERSION)
