...
#  GSTREAMERMM_INCLUDE_DIR - the GStreamermm include directory
...
if(GSTREAMERMM_INCLUDE_DIR AND
...
else(GSTREAMERMM_INCLUDE_DIR AND
      GSTREAMERMM_LIBRARIES AND
      GSTREAMERMM_PLUGINDEFS_LIBRARY OR (GSTREAMERMM_VERSION_MAJOR GREATER 0) AND
      GSTREAMERMM_VERSION_MAJOR EQUAL GStreamermm_FIND_VERSION_MAJOR AND
      GSTREAMERMM_VERSION_MINOR EQUAL GStreamermm_FIND_VERSION_MINOR)
...
endif(GSTREAMERMM_INCLUDE_DIR AND
       GSTREAMERMM_LIBRARIES AND
       GSTREAMERMM_PLUGINDEFS_LIBRARY OR (GSTREAMERMM_VERSION_MAJOR GREATER 0) AND
       GSTREAMERMM_VERSION_MAJOR EQUAL GStreamermm_FIND_VERSION_MAJOR AND
       GSTREAMERMM_VERSION_MINOR EQUAL GStreamermm_FIND_VERSION_MINOR)
...
if(GSTREAMERMM_INCLUDE_DIR)
else(GSTREAMERMM_INCLUDE_DIR)
   message(STATUS "GStreamermm: WARNING: include dir not found")
endif(GSTREAMERMM_INCLUDE_DIR)
...
if(GSTREAMERMM_INCLUDE_DIR AND GSTREAMERMM_LIBRARY AND GSTREAMERMM_PLUGINDEFS_LIBRARY OR (GSTREAMERMM_VERSION_MAJOR GREATER 0) )
   set(GSTREAMERMM_FOUND TRUE)
else(GSTREAMERMM_INCLUDE_DIR AND GSTREAMERMM_LIBRARY AND GSTREAMERMM_PLUGINDEFS_LIBRARY OR (GSTREAMERMM_VERSION_MAJOR GREATER 0) )
   set(GSTREAMERMM_FOUND FALSE)
endif(GSTREAMERMM_INCLUDE_DIR AND GSTREAMERMM_LIBRARY AND GSTREAMERMM_PLUGINDEFS_LIBRARY OR (GSTREAMERMM_VERSION_MAJOR GREATER 0) )
...
mark_as_advanced(GSTREAMERMM_INCLUDE_DIR GSTREAMERMM_LIBRARY GSTREAMERMM_PLUGINDEFS_LIBRARY GSTREAMERMM_LIBRARIES GSTREAMERMM_VERSION)
